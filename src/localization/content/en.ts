export const en = {
    ...
    items: [
      {
        ...
        crew: [
          ...
          {
            title: 'Art Director',
            member: ['TSENG, HSING-HSIEN', 'YEN, SUNG-PO', 'CHANG, CHI-YU'],
          },
          {
            title: 'Screenwriter',
            member: ['LIN, YI-HSUAN'],
      ...
      },
      {
        ...
        crew: [
          {
            title: 'Cast',
            member: ['TU, PIN-YANG', 'YANG, NAI-HSUAN'],
          },
          {
            title: 'Director / Screenwriter',
            member: ['CHEN, PO-HSIANG'],
          },
          {
            title: 'Cinematographer',
            member: ['MORALIS'],
    ...
    more: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            'The Satoyama Initiative traditionally refers to the landscape formed by forests, communities, and agricultural ecosystems between mountains and plains. In 2015, to achieve the vision of maintaining biodiversity conservation and sustainable use of resources, we voluntarily went to Akame Forest, Mie Prefecture, Japan to participate in a 14-day forest conservation program to assist local forest rehabilitation and exchange Taiwanese and Japanese culture to each other.',
        },
      ],
    },
  },
    ...
    items: [
      {
        ...
        jobs: [
          ...
          'Testing and refactoring code across browsers.',
        ],
      },
      {
        title: 'Department of New Media (Intern)',
        ...
        jobs: [
          ...
          'Build an official website using WordPress',
        ],
      },
      {
        title: 'Department of New Media (Intern)',
        company: 'Public Television Service (PTS) Taiwan',
  ...
  chitChat: {
    ...
    items: [
      {
        question: 'Which city do you come from?',
        answer:
          'Tanjung Balai Karimun, a lovely island about half the size of Taipei City, with an estimated population of 230,000 people. Most residents make a living by fishing, farming, and running businesses. The usual leisure activities are nothing more than enjoying the sea view and cycling around the island. There is no direct flight from Taiwan, so you have to fly to Singapore first, and then take a two-hour ferry ride (similar to the boat ship to Lambai Island) to arrive.',
      },
      {
        question: 'Why did you choose to study in Taiwan for university?',
        answer:
      ...
      },
      {
        ...
        answer:
          'Beef noodles, braised pork rice, fried chicken fillet, wheel pie, soymilk tofu pudding, chinese omelet, sesame flat bread, seasonal fruit.',
      },
      {
      ...
      {
        question:
          'Please list the books that have been read more than three times?',
        answer:
          "Can't Love Two Things (by Yataro Matsuura), Goodbye Things: The New Japanese Minimalism (by Fumio Sasaki), Sapiens: A Brief History of Humankind (by Yuval Noah Harari).",
      },
      {
        question: 'Top favorite movies',
        answer:
          'After the Storm, About Time, Manchester by the Sea, Inception, Arrival.',
      },
      {
        question: 'Most favorite movie quote',
        answer:
          'We are all traveling through time together every day of our lives. All we can do is do our best to relish this remarkable ride - About Time',
      },
    ],
  },
};

...
export const Font = createGlobalStyle`
  /* @font-face {
    ...
    font-weight: 100;
    font-display: swap;
    src: local('Noto Sans TC') url('/fonts/NotoSansTC-Thin.otf');
  }
  ...
  @font-face {
    ...
    font-weight: 500;
    font-display: swap;
    src: local('Noto Sans TC') url('/fonts/NotoSansTC-Medium.otf');
  }
  ...
  @font-face {
    ...
    font-weight: 700;
    font-display: swap;
    src: local('Noto Sans TC') url('/fonts/NotoSansTC-Bold.otf');
  } */
